...
public class TestShowDataToEdit {
	...
	public void test() throws ClientProtocolException, IOException {
		...
		try {
			...
			HttpGet request = new HttpGet(URI.create("http://127.0.0.1:4567/show_data_to_edit_route?user=")+ expectedUser);
	 	...
	 	Assert.assertEquals("Data List did not match", dataEditProfileExpected, dataEditProfileActual);
	}
